  ...
  return (
    <div className="max-w-xs rounded-lg overflow-hidden relative hover:-top-1 transition-all my-3 duration-[2800ms]">
      ...
      <div className="py-4">
        ...
        <p className="text-xs font-normal text-gray-800 mt-2">from <span className="line-through">₹12,612</span></p>
        {/* Price */}
        <div className="flex items-center gap-6 mt-2">

        <p className="text-md font-semibold text-gray-800">₹2,612</p>
